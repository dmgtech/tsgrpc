...
```
npm i @dmgtech/tsgrpc-protobuf-codec
```

```
yarn add @dmgtech/tsgrpc-protobuf-codec
```
...
```typescript
  import {WriteField as write, allocateNestingWriter, arrayCollector} from "@dmgtech/tsgrpc-protobuf-codec";
