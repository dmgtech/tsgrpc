...
function renderUnaryMethod(serviceFqName: string, method: MethodDescriptorProto, context: Context): Code {
    ...
    return [
        ...
        `${camelCase(methodName)}(request: Parameters<typeof ${requestJsName}.writeValue>[1], metadata: grpcWeb.Metadata | null, callback?: (err: grpcWeb.Error, response: ${responseJsName}.Strict) => void): Promise<${responseJsName}.Strict> | grpcWeb.ClientReadableStream<${responseJsName}.Strict> {`,
